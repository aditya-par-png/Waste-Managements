...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <main class="flex-grow">
    <header class="bg-green-100 py-10 text-center fade-up">
      <h1 class="text-4xl font-bold text-green-700 mb-2">Help & Support</h1>
      <p class="text-gray-600">Quick guide on how to use the app effectively</p>
    </header>

    <section class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md mt-6 fade-up">
      <h2 class="text-2xl font-semibold text-green-700 mb-6">How to Use This App</h2>
      <ul class="space-y-4 text-gray-700 list-decimal list-inside">
        <li>
          <strong>View your pickup schedule:</strong>
          Visit the <em>Schedule</em> page to check upcoming waste pickup dates and times.
        </li>
        <li>
          <strong>Request a new pickup:</strong>
          On the <em>Home</em> page, fill out the pickup form by selecting the waste type, date, and time, then submit.
        </li>
        <li>
          <strong>Payment information:</strong>
          Payment is made in cash on-site after collection. Ensure you have the correct amount ready.
        </li>
        <li>
          <strong>Stay updated:</strong>
          You'll receive notifications about your pickups, so check regularly for updates.
        </li>
      </ul>
    </section>
  </main>
